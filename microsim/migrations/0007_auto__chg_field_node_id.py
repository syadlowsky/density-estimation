...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.id'
        db.alter_column(u'microsim_node', 'id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Node.id'
        db.alter_column(u'microsim_node', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))
